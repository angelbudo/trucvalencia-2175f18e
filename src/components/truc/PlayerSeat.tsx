...
interface PlayerSeatProps {
  ...
  /**
   * Bloqueja l'aparició de l'interrogant de "torn actiu" mentre encara
   * queda algun bocadillo central pendent d'aparèixer (p. ex. el "Vull"
   * del rival). Així el "?" del jugador que ara ha de tirar apareix
   * exactament en el mateix frame que el bocadillo, sense desfasament.
   */
  suppressTurnQuestion?: boolean;
}
