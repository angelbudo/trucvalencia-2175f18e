...
/**
 * Resol un text de motiu (baneig / avís). Si comença amb el prefix
 * `i18n:` s'interpreta com una clau de traducció (per exemple
 * `i18n:ban.reasons.spam`); en cas contrari es retorna el text
 * literal (compatibilitat amb motius antics escrits a mà). Ha
 * d'invocar-se dins d'un component perquè es rerenderitze en
 * canviar l'idioma via `useT()`.
 */
