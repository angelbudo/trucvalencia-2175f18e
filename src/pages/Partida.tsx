  ...
  return (
    <>
      <TrucBoard
        ...
        implicitAcceptedByPlayer={implicitAcceptedByPlayer}
        ...
        implicitAcceptedEnvitByPlayer={implicitAcceptedEnvitByPlayer}
        messages={messages}
        onSay={handleSay}
        ...
        endgameSeatNames={{
          0: (myProfile?.display_name?.trim() || translate("common.you")),
          1: "Bot Der",
          2: "Company",
          3: "Bot Izq",
        }}
